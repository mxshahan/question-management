            ...
            addresses.push(
                ...
                />
                        <SelectBox
                            ...
                            onChange={(value) => this.onChangeAddressHandler(i, value)}
                            field='state'
                            data={this.props.geoLocation ? (this.props.geoLocation[i] ? this.props.geoLocation[i].states : []) : []}
                            disabled={
                                user ?
                                    user.addresses ?
                                        user.addresses.length > 0 ? (user.addresses[i] && !user.addresses[i].country)
                    ...
                    <div className="form-group row">
                        <SelectBox
                            ...
                            onChange={(value) => this.onChangeAddressHandler(i, value)}
                            field='city'
                            data={this.props.geoLocation ? (this.props.geoLocation[i] ? this.props.geoLocation[i].cities : []) : []}
                            disabled={
                                user ?
                                    user.addresses ?
                                        user.addresses.length > 0 ? (user.addresses[i] && !user.addresses[i].state)
